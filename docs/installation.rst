...
This is the preferred method to install Toki, as it will always install the most recent stable release.
...
The sources for Toki can be downloaded from the `Github repo`_.
